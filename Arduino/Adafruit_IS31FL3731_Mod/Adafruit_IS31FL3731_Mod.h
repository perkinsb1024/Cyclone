#ifndef _ADAFRUIT_IS31FL3731_MOD_H_
#define _ADAFRUIT_IS31Fl3731_MOD_H_
...
class Adafruit_IS31FL3731 : public Adafruit_GFX {
 public:
  ...
  void disableLedPage(uint8_t page);
  void enableLedPage(uint8_t page);
  void drawPixel(int16_t x, int16_t y, uint16_t color);
  void clear(void);
  void all_on(uint16_t color);
  void drawPixelBuffer(uint8_t *color, uint8_t start, uint8_t length);
